...
- name: io.k8s.api.resource.v1beta1.CapacitySharingPolicy
  map:
    ...
    - name: discreteValues
      type:
        namedType: io.k8s.api.resource.v1beta1.CapacitySharingPolicyDiscrete
    - name: valueRange
      type:
        namedType: io.k8s.api.resource.v1beta1.CapacitySharingPolicyRange
- name: io.k8s.api.resource.v1beta1.CapacitySharingPolicyDiscrete
  map:
    fields:
    - name: options
      type:
...
- name: io.k8s.api.resource.v1beta2.CapacitySharingPolicy
  map:
    ...
    - name: discreteValues
      type:
        namedType: io.k8s.api.resource.v1beta2.CapacitySharingPolicyDiscrete
    - name: valueRange
      type:
        namedType: io.k8s.api.resource.v1beta2.CapacitySharingPolicyRange
- name: io.k8s.api.resource.v1beta2.CapacitySharingPolicyDiscrete
  map:
    fields:
    - name: options
      type:
