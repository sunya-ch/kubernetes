...
type DeviceCapacityApplyConfiguration struct {
	...
	SharingPolicy *resourcev1beta2.CapacitySharingPolicy `json:"sharingPolicy,omitempty"`
}
...
func (b *DeviceCapacityApplyConfiguration) WithSharingPolicy(value resourcev1beta2.CapacitySharingPolicy) *DeviceCapacityApplyConfiguration {
