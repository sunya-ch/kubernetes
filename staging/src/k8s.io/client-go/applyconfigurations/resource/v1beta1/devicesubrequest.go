...
type DeviceSubRequestApplyConfiguration struct {
	...
	CapacityRequests *resourcev1beta1.CapacityRequirements `json:"capacityRequests,omitempty"`
}
...
func (b *DeviceSubRequestApplyConfiguration) WithCapacityRequests(value resourcev1beta1.CapacityRequirements) *DeviceSubRequestApplyConfiguration {
