...
type DeviceConstraintApplyConfiguration struct {
	...
	DistinctAttribute *resourcev1alpha3.FullyQualifiedName `json:"distinctAttribute,omitempty"`
}
...
func (b *DeviceConstraintApplyConfiguration) WithDistinctAttribute(value resourcev1alpha3.FullyQualifiedName) *DeviceConstraintApplyConfiguration {
