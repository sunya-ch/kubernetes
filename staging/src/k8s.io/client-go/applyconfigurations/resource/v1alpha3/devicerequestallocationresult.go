...
type DeviceRequestAllocationResultApplyConfiguration struct {
	...
	ShareUID           *string                                              `json:"shareUID,omitempty"`
	ConsumedCapacities map[resourcev1alpha3.QualifiedName]resource.Quantity `json:"consumedCapacities,omitempty"`
}
...
func (b *DeviceRequestAllocationResultApplyConfiguration) WithShareUID(value string) *DeviceRequestAllocationResultApplyConfiguration {
	b.ShareUID = &value
	return b
}
...
func (b *DeviceRequestAllocationResultApplyConfiguration) WithConsumedCapacities(entries map[resourcev1alpha3.QualifiedName]resource.Quantity) *DeviceRequestAllocationResultApplyConfiguration {
	if b.ConsumedCapacities == nil && len(entries) > 0 {
		b.ConsumedCapacities = make(map[resourcev1alpha3.QualifiedName]resource.Quantity, len(entries))
	}
