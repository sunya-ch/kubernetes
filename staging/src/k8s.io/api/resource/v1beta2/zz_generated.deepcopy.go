...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapacityClaimPolicy) DeepCopyInto(out *CapacityClaimPolicy) {
	*out = *in
	if in.Set != nil {
		in, out := &in.Set, &out.Set
		*out = new(CapacityClaimPolicySet)
		(*in).DeepCopyInto(*out)
	}
	if in.Range != nil {
		in, out := &in.Range, &out.Range
		*out = new(CapacityClaimPolicyRange)
		(*in).DeepCopyInto(*out)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapacityClaimPolicy.
func (in *CapacityClaimPolicy) DeepCopy() *CapacityClaimPolicy {
	if in == nil {
		return nil
	}
	out := new(CapacityClaimPolicy)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapacityClaimPolicyRange) DeepCopyInto(out *CapacityClaimPolicyRange) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapacityClaimPolicyRange.
func (in *CapacityClaimPolicyRange) DeepCopy() *CapacityClaimPolicyRange {
	if in == nil {
		return nil
	}
	out := new(CapacityClaimPolicyRange)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapacityClaimPolicySet) DeepCopyInto(out *CapacityClaimPolicySet) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapacityClaimPolicySet.
func (in *CapacityClaimPolicySet) DeepCopy() *CapacityClaimPolicySet {
	if in == nil {
		return nil
	}
	out := new(CapacityClaimPolicySet)
...
func (in *DeviceCapacity) DeepCopyInto(out *DeviceCapacity) {
	*out = *in
	...
	if in.ClaimPolicy != nil {
		in, out := &in.ClaimPolicy, &out.ClaimPolicy
		*out = new(CapacityClaimPolicy)
		(*in).DeepCopyInto(*out)
	}
	return
