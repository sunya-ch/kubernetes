...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapacitySharingPolicy) DeepCopyInto(out *CapacitySharingPolicy) {
	*out = *in
	out.Default = in.Default.DeepCopy()
	if in.DiscreteValues != nil {
		in, out := &in.DiscreteValues, &out.DiscreteValues
		*out = new(CapacitySharingPolicyDiscrete)
		(*in).DeepCopyInto(*out)
	}
	if in.ValueRange != nil {
		in, out := &in.ValueRange, &out.ValueRange
		*out = new(CapacitySharingPolicyRange)
		(*in).DeepCopyInto(*out)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapacitySharingPolicy.
func (in *CapacitySharingPolicy) DeepCopy() *CapacitySharingPolicy {
	if in == nil {
		return nil
	}
	out := new(CapacitySharingPolicy)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapacitySharingPolicyDiscrete) DeepCopyInto(out *CapacitySharingPolicyDiscrete) {
	*out = *in
	if in.Options != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapacitySharingPolicyDiscrete.
func (in *CapacitySharingPolicyDiscrete) DeepCopy() *CapacitySharingPolicyDiscrete {
	if in == nil {
		return nil
	}
	out := new(CapacitySharingPolicyDiscrete)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapacitySharingPolicyRange) DeepCopyInto(out *CapacitySharingPolicyRange) {
	*out = *in
	out.Minimum = in.Minimum.DeepCopy()
	if in.Maximum != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapacitySharingPolicyRange.
func (in *CapacitySharingPolicyRange) DeepCopy() *CapacitySharingPolicyRange {
	if in == nil {
		return nil
	}
	out := new(CapacitySharingPolicyRange)
...
func (in *DeviceRequest) DeepCopyInto(out *DeviceRequest) {
	*out = *in
	...
	if in.CapacityRequests != nil {
		in, out := &in.CapacityRequests, &out.CapacityRequests
		*out = new(CapacityRequirements)
		(*in).DeepCopyInto(*out)
	}
	return
...
func (in *DeviceRequestAllocationResult) DeepCopyInto(out *DeviceRequestAllocationResult) {
	*out = *in
	...
	if in.ConsumedCapacities != nil {
		in, out := &in.ConsumedCapacities, &out.ConsumedCapacities
		*out = make(map[QualifiedName]resource.Quantity, len(*in))
		for key, val := range *in {
			(*out)[key] = val.DeepCopy()
		}
