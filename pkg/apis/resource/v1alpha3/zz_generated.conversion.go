...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*resourcev1alpha3.CapacityRequirements)(nil), (*resource.CapacityRequirements)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_CapacityRequirements_To_resource_CapacityRequirements(a.(*resourcev1alpha3.CapacityRequirements), b.(*resource.CapacityRequirements), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*resource.CapacityRequirements)(nil), (*resourcev1alpha3.CapacityRequirements)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_resource_CapacityRequirements_To_v1alpha3_CapacityRequirements(a.(*resource.CapacityRequirements), b.(*resourcev1alpha3.CapacityRequirements), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_CapacityRequirements_To_resource_CapacityRequirements(in *resourcev1alpha3.CapacityRequirements, out *resource.CapacityRequirements, s conversion.Scope) error {
	out.Requests = *(*map[resource.QualifiedName]apiresource.Quantity)(unsafe.Pointer(&in.Requests))
	return nil
}

// Convert_v1alpha3_CapacityRequirements_To_resource_CapacityRequirements is an autogenerated conversion function.
func Convert_v1alpha3_CapacityRequirements_To_resource_CapacityRequirements(in *resourcev1alpha3.CapacityRequirements, out *resource.CapacityRequirements, s conversion.Scope) error {
	return autoConvert_v1alpha3_CapacityRequirements_To_resource_CapacityRequirements(in, out, s)
}

func autoConvert_resource_CapacityRequirements_To_v1alpha3_CapacityRequirements(in *resource.CapacityRequirements, out *resourcev1alpha3.CapacityRequirements, s conversion.Scope) error {
	out.Requests = *(*map[resourcev1alpha3.QualifiedName]apiresource.Quantity)(unsafe.Pointer(&in.Requests))
	return nil
}

// Convert_resource_CapacityRequirements_To_v1alpha3_CapacityRequirements is an autogenerated conversion function.
func Convert_resource_CapacityRequirements_To_v1alpha3_CapacityRequirements(in *resource.CapacityRequirements, out *resourcev1alpha3.CapacityRequirements, s conversion.Scope) error {
	return autoConvert_resource_CapacityRequirements_To_v1alpha3_CapacityRequirements(in, out, s)
}
...
func autoConvert_resource_DeviceConstraint_To_v1alpha3_DeviceConstraint(in *resource.DeviceConstraint, out *resourcev1alpha3.DeviceConstraint, s conversion.Scope) error {
	...
	out.DistinctAttribute = (*resourcev1alpha3.FullyQualifiedName)(unsafe.Pointer(in.DistinctAttribute))
	return nil
}
...
func autoConvert_resource_DeviceSubRequest_To_v1alpha3_DeviceSubRequest(in *resource.DeviceSubRequest, out *resourcev1alpha3.DeviceSubRequest, s conversion.Scope) error {
	...
	out.Count = in.Count
	out.Tolerations = *(*[]resourcev1alpha3.DeviceToleration)(unsafe.Pointer(&in.Tolerations))
	out.Capacities = (*resourcev1alpha3.CapacityRequirements)(unsafe.Pointer(in.Capacities))
	return nil
}
