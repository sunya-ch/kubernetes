...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*resourcev1beta1.CapacitySharingPolicyDiscrete)(nil), (*resource.CapacitySharingPolicyDiscrete)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_CapacitySharingPolicyDiscrete_To_resource_CapacitySharingPolicyDiscrete(a.(*resourcev1beta1.CapacitySharingPolicyDiscrete), b.(*resource.CapacitySharingPolicyDiscrete), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*resource.CapacitySharingPolicyDiscrete)(nil), (*resourcev1beta1.CapacitySharingPolicyDiscrete)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_resource_CapacitySharingPolicyDiscrete_To_v1beta1_CapacitySharingPolicyDiscrete(a.(*resource.CapacitySharingPolicyDiscrete), b.(*resourcev1beta1.CapacitySharingPolicyDiscrete), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_CapacitySharingPolicyDiscrete_To_resource_CapacitySharingPolicyDiscrete(in *resourcev1beta1.CapacitySharingPolicyDiscrete, out *resource.CapacitySharingPolicyDiscrete, s conversion.Scope) error {
	out.Options = *(*[]apiresource.Quantity)(unsafe.Pointer(&in.Options))
	return nil
}

// Convert_v1beta1_CapacitySharingPolicyDiscrete_To_resource_CapacitySharingPolicyDiscrete is an autogenerated conversion function.
func Convert_v1beta1_CapacitySharingPolicyDiscrete_To_resource_CapacitySharingPolicyDiscrete(in *resourcev1beta1.CapacitySharingPolicyDiscrete, out *resource.CapacitySharingPolicyDiscrete, s conversion.Scope) error {
	return autoConvert_v1beta1_CapacitySharingPolicyDiscrete_To_resource_CapacitySharingPolicyDiscrete(in, out, s)
}

func autoConvert_resource_CapacitySharingPolicyDiscrete_To_v1beta1_CapacitySharingPolicyDiscrete(in *resource.CapacitySharingPolicyDiscrete, out *resourcev1beta1.CapacitySharingPolicyDiscrete, s conversion.Scope) error {
	out.Options = *(*[]apiresource.Quantity)(unsafe.Pointer(&in.Options))
	return nil
}

// Convert_resource_CapacitySharingPolicyDiscrete_To_v1beta1_CapacitySharingPolicyDiscrete is an autogenerated conversion function.
func Convert_resource_CapacitySharingPolicyDiscrete_To_v1beta1_CapacitySharingPolicyDiscrete(in *resource.CapacitySharingPolicyDiscrete, out *resourcev1beta1.CapacitySharingPolicyDiscrete, s conversion.Scope) error {
	return autoConvert_resource_CapacitySharingPolicyDiscrete_To_v1beta1_CapacitySharingPolicyDiscrete(in, out, s)
}
